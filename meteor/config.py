...
class Config:
    ...
    DGRAPH_ENDPOINT = os.environ.get('DGRAPH_ENDPOINT', 'localhost:9080')
    DGRAPH_CREDENTIALS = os.environ.get('DGRAPH_CREDENTIALS', None)
    DGRAPH_OPTIONS = os.environ.get('DGRAPH_OPTIONS', None)
